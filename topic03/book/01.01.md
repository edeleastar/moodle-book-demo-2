...
In eclipse, create a new 'Static Web Project' called "lab03". This time we will not be using any content from the previous labs.

In this project create two files in the default 'WebContent' folder:
